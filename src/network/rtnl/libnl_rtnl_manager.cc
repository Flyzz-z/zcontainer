...
void LibnlRTNLManager::CreateVethPair(const std::string &name1, const std::string &name2) {}

void LibnlRTNLManager::AddLinkToBridge(const std::string &link, const std::string &bridge) {
